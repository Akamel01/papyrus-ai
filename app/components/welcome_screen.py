...
<div style="display:flex;flex-wrap:wrap;justify-content:center;gap:16px;margin-bottom:32px;width:100%;max-width:48rem;padding:0 16px;box-sizing:border-box;">

<div class="glass-card" style="padding:16px;border-radius:12px;display:flex;flex-direction:column;align-items:center;text-align:center;flex:1 1 200px;min-width:180px;max-width:250px;">
